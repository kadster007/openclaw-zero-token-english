...
export const GENERATED_BUNDLED_PLUGIN_METADATA = [
    ...
    packageName: "@openclaw/askonce",
    packageVersion: "2026.3.28",
    packageDescription: "Query multiple AI models simultaneously with a single question",
    packageManifest: {
  ...
  },
  {
    ...
    packageManifest: {
      ...
      channel: {
        ...
        docsLabel: "feishu",
        blurb: "Feishu/Lark enterprise messaging with doc/wiki/drive tools.",
        aliases: ["lark"],
        order: 35,
    ...
    manifest: {
      ...
      channelConfigs: {
        feishu: {
          ...
          label: "Feishu",
          description: "Feishu/Lark enterprise messaging with doc/wiki/drive tools.",
        },
      },
    },
  },
